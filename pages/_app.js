...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio | Herman";
	const description =
		"Hello! I'm Software Engineer, a passionate web developer and problem solver. Welcome to my portfolio";
	const avatar =
	...
	const url = "https://bruno-3d-portfolio.netlify.app/";
	...
	return (
		<>
			<Head>
				...
				<meta name="twitter:creator" content="@BrunoCat118" />
